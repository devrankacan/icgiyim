...
export default function DuzenleKategoriPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <div>
      <div className="flex items-center gap-3 mb-8">
        ...
        <h1 className="text-2xl font-bold text-white">Kategoriyi Düzenle</h1>
      </div>
        ...
        <div className="bg-gray-900 rounded-xl p-6 border border-gray-800 space-y-5">
          ...
          <Field label="Slug">
            <input type="text" required value={form.slug}
              ...
              className={inputCls} />
            <p className="text-xs text-gray-500 mt-1">Slug değiştirilirse mevcut URL'ler çalışmaz.</p>
          </Field>
