      ...
      <form onSubmit={handleSubmit} className="max-w-2xl space-y-6">
        ...
        <div className="bg-gray-900 rounded-xl p-6 border border-gray-800 space-y-5">
          ...
          <Field label="Ürün Detayları (her satır bir madde)">
            <textarea required rows={4} value={form.details}
              onChange={(e) => setForm((f) => ({ ...f, details: e.target.value }))}
              className={inputCls} />
          </Field>

          <Field label="Bedenler (virgülle ayırın)">
            <input type="text" required value={form.sizes}
              onChange={(e) => setForm((f) => ({ ...f, sizes: e.target.value }))}
              className={inputCls} />
          </Field>

          <Field label="Renkler (virgülle ayırın)">
            <input type="text" required value={form.colors}
        ...
        <div className="bg-gray-900 rounded-xl p-6 border border-gray-800 space-y-5">
          ...
          <Field label="Rozet (opsiyonel)">
            <input type="text" value={form.badge}
              ...
              className={inputCls} placeholder="Örn: İndirim" />
          </Field>
